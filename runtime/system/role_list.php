...
<div class="container">
	...
	<div id="admin_right">
	<div class="headbar">
	<div class="position"><span>Hospital</span><span>></span><span>Position</span><span>></span><span>List</span></div>
	<div class="operating">
		<a href="javascript:;" onclick="event_link('<?php echo IUrl::creatUrl("/system/role_edit");?>')"><button class="operating_btn" type="button"><span class="addition">Add New Position</span></button></a>
		...
		<a href="javascript:;" onclick="event_link('<?php echo IUrl::creatUrl("/system/role_recycle");?>')"><button class="operating_btn" type="button"><span class="recycle">Recycle Bin</span></button></a>
	</div>
	<div class="field">
		...
		<table id="list_table" class="list_table">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a href='<?php echo IUrl::creatUrl("/system/role_edit/id/$item[id]");?>'><img class="operator" src="<?php echo IUrl::creatUrl("")."views/".$this->theme."/skin/".$this->skin."/images/admin/icon_edit.gif";?>" alt="编辑" title="编辑" /></a>
						<a href='javascript:void(0)' onclick="delModel({link:'<?php echo IUrl::creatUrl("/system/role_update/recycle/del/id/$item[id]");?>',msg:'是否把信息放到回收站内？'});"><img class="operator" src="<?php echo IUrl::creatUrl("")."views/".$this->theme."/skin/".$this->skin."/images/admin/icon_del.gif";?>" alt="删除" title="删除" /></a>
					</td>
				</tr>
				<?php }?>
			</tbody>
