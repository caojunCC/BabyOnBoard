...
<div class="headbar">
	<div class="position"><span>Mastercode</span><span>></span><span>Anesthesia problems</span><span>></span><span><?php if(isset($id)){?>Edit anesthesia problems<?php }else{?>Add new anesthesia problems<?php }?></span></div>
</div>
<div class="content_box">
	<div class="content form_content">
		<form action="<?php echo IUrl::creatUrl("/mastercode/anesthesia_problems_edit_act");?>" method="post">
