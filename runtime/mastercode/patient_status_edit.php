...
<div class="headbar">
	<div class="position"><span>Mastercode</span><span>></span><span>Patient status</span><span>></span><span><?php if(isset($id)){?>Edit Hospital Detail<?php }else{?>Add new patient status<?php }?></span></div>
</div>
<div class="content_box">
	<div class="content form_content">
		<form action="<?php echo IUrl::creatUrl("/mastercode/patient_status_edit_act");?>" method="post">
