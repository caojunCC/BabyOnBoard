...
<div class="container">
	...
	<div id="admin_right">
	<div class="headbar">
    <div class="position"><span>Mastercode</span><span>></span><span>Presentation</span><span>></span><span>Presentation list</span></div>
    <div class="operating">
        <a href="javascript:void(0)" onclick="event_link('<?php echo IUrl::creatUrl("/mastercode/presentation_edit");?>')"><button class="operating_btn" type="button"><span class="addition">Add new presentation</span></button></a>
...
<div class="content">
    <form action="<?php echo IUrl::creatUrl("/mastercode/presentation_del");?>" method="post" name="presentation">
        <table class="list_table">
            <col width="40px" />
            <col width="30%" />
            <col width="30%" />
           ...
           <?php $page= (isset($_GET['page'])&&(intval($_GET['page'])>0))?intval($_GET['page']):1;?>
        	<?php $query = new IQuery("presentation as p");$query->order = "p.order asc";$query->page = "$page";$query->pagesize = "20";$items = $query->find(); foreach($items as $key => $item){?> 
             	  <tr>
					...
					<td>
                        <a href='<?php echo IUrl::creatUrl("/mastercode/presentation_edit/id/");?><?php echo isset($item['id'])?$item['id']:"";?>'><img class="operator" src="<?php echo IUrl::creatUrl("")."views/".$this->theme."/skin/".$this->skin."/images/admin/icon_edit.gif";?>" alt="编辑" title="编辑" /></a>
                        <a href='javascript:void(0)' onclick="delModel({link:'<?php echo IUrl::creatUrl("/mastercode/presentation_del/id/$item[id]");?>'});"><img class="operator" src="<?php echo IUrl::creatUrl("")."views/".$this->theme."/skin/".$this->skin."/images/admin/icon_del.gif";?>" alt="删除" title="删除" /></a>
                    </td>
				   </tr>
				<?php }?>
