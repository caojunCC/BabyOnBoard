...
<div class="content_box">
	<div class="content form_content">
		<form action="<?php echo IUrl::creatUrl("/brand/category_save/");?>" method="post">
			<table class="form_table">	
				<col width="150px" />
				<col />
				<tr>
					<th>分类名称：</th>
					<td><input class="normal" name="name" type="text" value="<?php echo isset($category['name'])?$category['name']:"";?>" pattern="required" alt="分类名称不能为空" /><label>*</label>
