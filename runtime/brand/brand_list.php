...
<form action="<?php echo IUrl::creatUrl("/brand/brand_sort");?>" method="post" name="category_list">
<div class="content">
	<table id="list_table" class="list_table">
		...
		<tbody>
			...
			<tr>
				<td><input class="tiny" name="sort[<?php echo isset($item['id'])?$item['id']:"";?>]" type="text" value="<?php echo isset($item['sort'])?$item['sort']:"";?>" pattern='int' /></td>
