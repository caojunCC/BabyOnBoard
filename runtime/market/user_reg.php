...
<?php $fc=new FlashChart(IUrl::creatUrl("").'chart/',"100%",320);$info=array("title"=>'用户注册统计','numbers'=>$this->numbers,'dates'=>$this->dates,'steps'=>$this->steps,'max'=>$this->max);$fc->setChart("chart/templatechart/user-add.txt",$info);?>
<?php }else{?>
<script type='text/javascript'>
