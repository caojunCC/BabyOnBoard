	...
	<table id="list_table" class="list_table">
		...
		<tbody>
			...
			<tr>
				...
				<td><a href="member_edit/uid/<?php echo isset($item['user_id'])?$item['user_id']:"";?>"><img class="operator" src="<?php echo IUrl::creatUrl("")."views/".$this->theme."/skin/".$this->skin."/images/admin/icon_edit.gif";?>" alt="修改" /></a>
					<a href="member_del/check/<?php echo isset($item['user_id'])?$item['user_id']:"";?>"><img class="operator" src="<?php echo IUrl::creatUrl("")."views/".$this->theme."/skin/".$this->skin."/images/admin/icon_del.gif";?>" alt="删除" /></a>
				</td>
			</tr>
			<?php }?>
		</tbody>
...
<?php echo $query->getPageBar('/member/member_list/');?>
</form>
