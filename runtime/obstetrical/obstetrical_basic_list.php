		...
		success: function(data){
			if(data)
			{
				...
				for(i=0;i< data.length;i++)
				{
					...
					"<td>"+data[i].date+"</td>"+
					"<td>"+
					 "<a href='<?php echo IUrl::creatUrl("/obstetrical/obstetrical_basic_edit/id/");?>"+data[i].id+"'><img class=\"operator\" src=\"<?php echo IUrl::creatUrl("")."views/".$this->theme."/skin/".$this->skin."/images/admin/icon_edit.gif";?>\" alt=\"编辑\" title=\"编辑\" /></a>"+
