		...
		success: function(data){
			if(data)
			{
				...
				for(i=0;i< data.length;i++)
				{
					...
					"<td>"+data[i].date+"</td>"+
					"<td>"+
					 "<a href='<?php echo IUrl::creatUrl("/obstetrical/anesthesia_surgery_edit/id/");?>"+data[i].id+"'><img class=\"operator\" src=\"<?php echo IUrl::creatUrl("")."views/".$this->theme."/skin/".$this->skin."/images/admin/icon_check.gif";?>\" alt=\"查看\" title=\"查看\" /></a>"+
