...
<div class="container">
	...
	<div id="admin_right">
	<div class="headbar">
	<div class="position"><span>会员</span><span>></span><span>邮件短信设置</span><span>></span><span>模板管理</span></div>
	<div class="field">
...
<div class="content">
	<table id="list_table" class="list_table">
		...
		<col width="100px" />
		<tbody>
			<?php foreach($tpl as $key => $item){?>
			<tr>
				<td></td>
				<td><?php echo isset($item['name'])?$item['name']:"";?></td>
				<td><a href="<?php echo IUrl::creatUrl("/message/tpl_edit/tid/$item[id]");?>"><img class='operator' src='<?php echo IUrl::creatUrl("")."views/".$this->theme."/skin/".$this->skin."/images/admin/icon_edit.gif";?>' title='编辑模板' /></a></td>
			</tr>
			<?php }?>
		</tbody>
	</table>
