...
$.jQchart={
	version  : '0.03-beta-1.2',
	updateMemo : 'v0.03-beta-1.2 add callback function ondrawend',
		...
		jQuery.extend( $.fn.jQchart,{
			...
			init :	function (op){
				...
				this.op=jQuery.extend({
					...
					ondrawend	: op.config.ondrawend || null //function(oj){}
				...
				this.op.labelYunitTop	=this.op.paddingT-this.op.labelYunitFontSize	|| '';
			...
			drawLine : function (op,it){
				...
				//タイトルへ
				it.wrtTitle(it.op);
				if(it.op.ondrawend)it.op.ondrawend(it);
