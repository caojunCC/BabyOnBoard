...
//	    echo $this->array_to_string($condition);
	}
	/**
	 *导出数据转换
	 * @param <array> $result
	...
	function array_to_string($result)
	{
	    ...
	    $this->i("销售价格"),$this->i("市场价格"),$this->i("创建时间"),$this->i("库存"),$this->i("原图"),
	    ...
	    foreach ($result as $value)
	    {
	    	...
	    	$good = array("gid",$this->i($info['name']),$info['goods_no'],$info['model_id'],
		    	$info['sell_price'],$info['market_price'],$info['create_time'],$info['store_nums'],$info['img'],
